...
## Quality re-review follow-up

- Closed the same-tick submit/change race by adding `canChange()` to the mounted submission controller and requiring both reducer editability and the synchronous controller lock in `dispatchGenerativeFormChange`.
