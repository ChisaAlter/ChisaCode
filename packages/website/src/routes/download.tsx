...
export const Route = createFileRoute("/download")({
  head: () =>
    pageMeta(
      "Download ChisaCode for macOS, Windows, Linux, iOS, and Android",
      "Install ChisaCode on every platform. Native desktop apps for macOS, Windows, and Linux. Mobile apps for iOS and Android. Self-hosted, open source, free to download.",
      "/download",
    ),
  component: Download,
});
      ...
      <section className="rounded-xl border border-border bg-card/40 p-6 md:p-8 mb-6">
        ...
        <div className="divide-y divide-border">
          ...
          <div className="flex flex-col gap-3 py-5 first:pt-0 last:pb-0 sm:flex-row sm:items-center sm:justify-between">
            ...
            <CodeBlock size="sm">brew install --cask chisacode</CodeBlock>
          </div>
      ...
      <section className="rounded-xl border border-border bg-card/40 p-6 md:p-8">
        ...
        <div className="divide-y divide-border">
          <div className="flex flex-col gap-3 py-5 first:pt-0 last:pb-0 sm:flex-row sm:items-center sm:justify-between">
            ...
            <CodeBlock size="sm">npm install -g @chisacode/cli && chisacode</CodeBlock>
          </div>
          ...
          <div className="flex flex-col gap-3 py-5 first:pt-0 last:pb-0 sm:flex-row sm:items-center sm:justify-between">
            ...
            <CodeBlock size="sm">nix run github:getchisacode/chisacode</CodeBlock>
          </div>
        </div>
      </section>
