...
} from "@chisacode/protocol/terminal-input-mode";
import {
...
export class TerminalEmulatorRuntime {
  ...
  unmount(): void {
    ...
    this.cleanup?.();
    this.cleanup = null;
    if (window.__chisacodeTerminal === this.terminal) {
      window.__chisacodeTerminal = undefined;
    }
    this.terminal = null;
    this.fitAddon = null;
