import type { ChisaCodeConfigRaw } from "@chisacode/protocol/messages";
...
interface ReadProjectConfigResult {
  ok: boolean;
  config?: ChisaCodeConfigRaw | null;
}
...
function hasSetupCommands(config: ChisaCodeConfigRaw): boolean {
