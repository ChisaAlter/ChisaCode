...
export function AdaptiveRenameModal({
  ...
  const resolvedSubmitLabel = submitLabel ?? t("common.rename");
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      setIsPending(false);
      const message = err instanceof Error && err.message ? err.message : t("common.unableToSave");
      setError(message);
    }
      ...
      <View style={styles.body}>
        ...
        <View style={styles.actions}>
          ...
          <Button
            ...
            testID={submitTestID}
          >
            {isPending ? t("common.saving") : resolvedSubmitLabel}
          </Button>
        </View>
      </View>
    </AdaptiveModalSheet>
