...
describe("shouldShowWorktreeSetupCallout", () => {
  it("shows the callout when chisacode config was read and setup commands are missing", () => {
  ...
  it("does not show the callout when reading chisacode config fails or has not completed", () => {
