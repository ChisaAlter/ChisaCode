 ...
 *
 * `serverId` is a stable daemon identifier scoped to `CHISACODE_HOME`, and is also
...
/**
 * Parse a pairing-offer URL of the form `https://app.chisacode.sh/#offer=<base64url>`.
 *
