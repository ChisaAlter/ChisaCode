...
- **状态**：进行中；Codex Session 已收敛为 715 行 orchestrator；Claude timeline assembler、SDK pump reader、message router 与 history converter 已完成，主文件当前 4342 行。下一步拆 Claude tool-call handlers 或 SDK types mapping 边界。
