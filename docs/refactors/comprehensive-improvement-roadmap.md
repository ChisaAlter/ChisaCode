...
- **状态**：进行中；Codex Session 已收敛为 715 行 orchestrator；Claude timeline assembler、SDK pump reader 与 message router 已完成，主文件当前 4643 行。下一步拆 Claude tool-call handlers 或 history converter 边界。
