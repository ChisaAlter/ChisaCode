...
- **状态**：进行中；Codex Session 已收敛为 715 行 orchestrator；Claude timeline assembler、SDK pump reader、message router、history converter 与 tool-call handlers 已完成，主文件当前 3760 行。下一步拆 Claude SDK types mapping，随后分离 Session/Client。
