...
- **当前批次**：处理 Android module version metadata、wildcard daemon 测试密码夹具、过期 provider model IDs，以及 Server E2E 的 Windows 路径规范化与级联超时；Desktop Chain/Playwright 结合新矩阵复核。
