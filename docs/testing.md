...
| `*.real.e2e.test.ts`  | E2E that hits a real provider (Claude/Codex/OpenCode/MiMoCode/Pi/Kimi) — needs creds in `packages/server/.env.test` | `npm run test:integration:real` / `test:e2e:real`                                    |
